...
#         **params
#     ):
#         super(TupleList, self).__init__(default=default, instantiate=True, **params)
#         self.class_ = class_
#         self.bounds = bounds
...
#             assert len(v) == self.length, "{} does not have length {}".format(
#                 v, self.length
#             )
#             if self.class_ is not None:
#                 for vv in v:
#                     assert isinstance(vv, self.class_), "{} is not a {}".format(
#                         vv, self.class_
#                     )
